      ...
      body: Obx(() => SingleChildScrollView(
            child: Column(
              children: [
                ...
                _buildItemView(
                  label: StrRes.paymentPassword,
                  value: logic.hasPaymentPassword.value ? '已设置' : '未设置',
                  onTap: logic.setPaymentPassword,
                  showRightArrow: true,
                ),
                _buildItemView(
                  ...
                  trailing: Obx(() => CupertinoSwitch(
                        value: logic.isBiometricEnabled.value,
                        onChanged: (value) => logic.toggleBiometric(value),
                        activeColor: Styles.c_0089FF,
                        trackColor: Styles.c_E8EAEF,
