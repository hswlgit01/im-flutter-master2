...
class LogUtil {
  ...
  static void e(String tag, String message,
    ...
    if (_enabled && _level.index <= LogLevel.error.index) {
      _print('E', tag, message, error: error, stackTrace: stackTrace);
    }
  }
  ...
  static void _print(
    ...
    debugPrint(logStr);
    if (error != null) {
      debugPrint('[$level/$tag] Error: $error');
    }
    if (stackTrace != null) {
      debugPrint('[$level/$tag] Stack: $stackTrace');
    }
    ...
    AppLogUploader.instance.capture(
      level,
      tag,
      message,
      error: error,
