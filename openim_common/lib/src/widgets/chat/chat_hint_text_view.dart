        ...
        case MessageType.memberInvitedNotification:
          {
            ...
            text.splitMapJoin(
              ...
              onNonMatch: (text) {
                children
                    .add(TextSpan(text: text, style: Styles.ts_8E9AB0_12sp));
                return '';
              },
            );
        ...
        case MessageType.revokeMessageNotification:
          {
            ...
            TextSpan revoker = TextSpan(
              text: revokedInfo.revokerID == OpenIM.iMManager.userID
                  ? StrRes.you
                  : revokedInfo.revokerNickname,
              style: Styles.ts_0089FF_12sp,
              recognizer: TapGestureRecognizer()
                ..onTap = () => onTapUserProfile((
                      userID: revokedInfo.revokerID!,
                      name: revokedInfo.revokerNickname!,
                      faceURL: null,
                      groupID: groupID
                    )),
            );

            TextSpan sourceUser = TextSpan(
              text: revokedInfo.sourceMessageSendID == OpenIM.iMManager.userID
                  ? StrRes.you
                  : revokedInfo.sourceMessageSenderNickname,
              style: Styles.ts_0089FF_12sp,
              recognizer: TapGestureRecognizer()
                ..onTap = () => onTapUserProfile((
                      userID: revokedInfo.sourceMessageSendID!,
                      name: revokedInfo.sourceMessageSenderNickname!,
                      faceURL: null,
                      groupID: groupID
                    )),
            );
            ...
            return RichTextSprintf(StrRes.aRevokeBMsg, [revoker, sourceUser],
                textAlign: TextAlign.center, style: Styles.ts_8E9AB0_12sp);
          }
      }
