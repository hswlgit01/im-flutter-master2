...
class ChatText extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final hasUrlPattern = patterns.any((e) => e.type == PatternType.url);
    final mergedPatterns = <MatchPattern>[
      ...patterns,
      if (!hasUrlPattern)
        MatchPattern(
    ...
    return MatchTextView(
      text: text,
      textStyle:
      textStyle ?? (isISend ? Styles.ts_FFFFFF_17sp : Styles.ts_0C1C33_17sp),
