...
class Styles {
  ...
  static Color c_F2F4F7 = const Color(0xFFF2F4F7); // 浅灰背景色

  static Color c_FFFFFF_opacity0 = c_FFFFFF.withOpacity(.0);
  static Color c_FFFFFF_opacity70 = c_FFFFFF.withOpacity(.7);
  static Color c_0C1C33_70 = c_0C1C33.withOpacity(.7); // 黑色字体70%透明度
  ...
  static const TextStyle ts_0C1C33_16sp_medium = TextStyle(
    color: Color(0xFF0C1C33),
    fontSize: 16,
    fontWeight: FontWeight.w500,
  );
  
  static const TextStyle ts_0C1C33_18sp_medium = TextStyle(
    color: Color(0xFF0C1C33),
    fontSize: 18,
    fontWeight: FontWeight.w500,
  );
  ...
  static TextStyle ts_0C1C33_24sp_medium = TextStyle(
    color: c_0C1C33,
    fontSize: 24.sp,
    fontWeight: FontWeight.w500,
  );
